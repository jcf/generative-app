  ...
  {:generative-app
   {;; :build contains parameters which are passed to the build
    :build {;; :watch-files contains a list of files to watch for
            ...
            ;; the templates.
            :triggers {:html [#"generative_app/rendering.js"]}}
    ...
    :built-in {:render {;; The directory where rendering scripts
                        ...
                        :renderer 'generative_app.rendering
    ...
    :aspects {;; Add an aspect that uses the data renderer
              ...
              :development {:uri "/generative-app-dev.html"
                            :name "Development"
                            :out-file "generative-app-dev.js"
                            :main 'generative_app.start
                            :logging? true
                            :order 3}
              :fresh {:uri "/fresh.html"
                      ...
                      :output-root :tools-public
                      :template "tooling.html"}
              :production {:uri "/generative-app.html"
                           :name "Production"
                           :optimizations :advanced
                           :out-file "generative-app.js"
                           :main 'generative_app.start
                           :order 5}}}})
